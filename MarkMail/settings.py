"""
Django settings for MarkMail project.
...
ALLOWED_HOSTS = ["markmail.vercel.app", "markmail.onrender.com"]
...
WSGI_APPLICATION = 'MarkMail.wsgi.application'
...
AUTH_USER_MODEL = 'mail.MarkMailUser'
